          ...
          <ul class="space-y-2 font-medium">
            <li>
              <button
                ...
                class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group justify-start"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span class="ml-3">Booked Seats</span>
              </button>
            </li>
          </ul>
        </div>
